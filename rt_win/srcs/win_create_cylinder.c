...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/04/25 22:32:44 by jogarcia          #+#    #+#             */
/*   Updated: 2017/05/21 05:53:58 by jogarcia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void			init_bg(t_mmlx *child)
{
	...
	if ((img = mlx_xpm_file_to_image(child->mlx, BG_CYLINDER, &width, &height)))
	{
...
static t_datawin	init_datawin(int ret)
{
	return ((t_datawin){.xwin = WIN_XLEN_EDIT, .ywin = WIN_YLEN_EDIT,
		.name = WIN_NAME_CYLINDER, .f_keypress = rt_fkeypress,
